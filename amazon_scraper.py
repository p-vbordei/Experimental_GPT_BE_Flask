# https://github.com/praneethravuri/Amazon-Product-Information-Scraper/blob/main/amazon_scraper.py
import os
import time
...
class AmazonProductScraper:
    ...
    def open_browser(self):
        ...
        self.driver = webdriver.Chrome(executable_path=ChromeDriverManager().install(), options=opt)
    ...
    def extract_product_information(page_results):
        print(">> extract_product_information() - start")
        temp_record = []
    ...
    def navigate_to_other_pages(self, category_url):
        ...
        try:
            ...
            try:
                ...
                print("Could not find the maximum number of pages.")
                return records
        ...
        print(">> navigate_to_other_pages() - end")
        return records
